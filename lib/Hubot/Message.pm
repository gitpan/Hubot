...
{
  $Hubot::TextMessage::VERSION = '0.1.3';
}
use Moose;
use namespace::autoclean;
...
{
  $Hubot::EnterMessage::VERSION = '0.1.3';
}
use Moose;
use namespace::autoclean;
extends 'Hubot::Message';
...
{
  $Hubot::LeaveMessage::VERSION = '0.1.3';
}
use Moose;
use namespace::autoclean;
extends 'Hubot::Message';
...
{
  $Hubot::WhisperMessage::VERSION = '0.1.3';
}
use Moose;
use namespace::autoclean;
...
{
  $Hubot::CatchAllMessage::VERSION = '0.1.3';
}
use Moose;
use namespace::autoclean;
extends 'Hubot::Message';
